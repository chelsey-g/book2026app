-- ============================================
-- BookTracker Complete Setup SQL
...
-- ============================================
-- Grant Permissions (if using restricted roles)
-- ============================================
...
-- Security is handled by the underlying table permissions.
-- book_statistics: Public view, safe to read
-- user_reading_stats: Aggregated from user_books (which has RLS)
-- user_genre_preferences: Aggregated from user_books (which has RLS)

-- ============================================
-- Sample Data (Optional - for testing)
-- ============================================

-- Uncomment to add sample trending boost to some books
-- UPDATE public.books SET view_count = 100 WHERE id IN (SELECT id FROM public.books LIMIT 5);
